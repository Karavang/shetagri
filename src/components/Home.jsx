    ...
    <div className="homestyle">
      <section className="hero heroAboutMe">
        <div className="hero-indiv">
          ...
          <p className="hero-p">
            `Дорогу здолає той, хто йде` <br /> Сократ
          </p>
        </div>
      </section>
      <section className="home-about ">
        <div className="abzac">
         ...
         <div className="paragraph">Основний метод моєї роботи - <span className="fat">Транзакційний аналіз</span>. За необхідності  додаю методи схема-терапії, травма-фокусу, психосоматичної релаксації, арт-терапії. Детальніше тут. ❇️</div>
         ...
         <div className="paragraph"> Я надаю індивідуальні консультації, а також працюю з парами та сім’ями.  Мої пропозиції покращити життя адресовані дорослим і підліткам.</div>
          ...
          <span className="fat"> унікальну психіку</span>, свою історію життя, свої проблеми. Тому для кожного клієнта я індивідуально підбираю методи роботи.. 💌
          <br />
          <br />
